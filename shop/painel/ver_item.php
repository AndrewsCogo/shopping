...
<!--<center><input type="button" value="Recarregar" onclick="carregar('painel/ver_item.php?id=<?php echo $_GET['id']; ?>','Centro','GET')" /></center>-->
<?php
...
<input type="hidden" name="tipo_compra" id="tipo_compra" value="<?php echo $compra_tipo; ?>" />
...
<div id="CompraBox">
	...
	<?php if($compra_tipo == 0 && $Mostrar_Valor_Real == 1) echo "<div id=\"vReal\" value=\"\"></div>"; ?>
...
<script type="text/javascript">
	SetPrecos();
	setInterval('Pisca()', 300);
	setInterval('Total()', 150);
	<?php if($compra_tipo == 0 && $Mostrar_Valor_Real == 1)echo "ConverterValorCash('$listar_item[2]', 'vReal');"; ?>
</script>