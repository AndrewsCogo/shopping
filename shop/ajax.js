...
{
	var Liberado = 0;
	if(requrl.indexOf("itens.php") < 0) 	Liberado = 1;
	if(requrl.indexOf("ver_item.php") < 0) 	Liberado = 1;
	if(requrl.indexOf("principal.php") < 0) Liberado = 1;
	
	if(Liberado == 1)
	{
		if(requrl.indexOf("?") < 0)
		{
			requrl = requrl + '?compra_tipo=' + compra_tipo;
		}else
		{
			requrl = requrl + '&compra_tipo=' + compra_tipo;
		}
